...
def SinGAN_generate(Gs,Zs,reals,NoiseAmp,opt,in_s=None,scale_w=1,scale_v=1,scale_h=1,n=0,gen_start_scale=0,num_samples=50):
    ...
    for G,Z_opt,noise_amp in zip(Gs,Zs,NoiseAmp):
        ...
        nzz = (Z_opt.shape[2]-pad1*2)*scale_w
